    ...
    where TEntity : class, IEntity where TContext : DbContext
{
    ...
    protected async ValueTask<TEntity> CreateAsync(TEntity entity, bool saveChanges = true, CancellationToken cancellationToken = default)
    {
        ...
        var resultEntity = (await DbContext.Set<TEntity>().AddAsync(entity)).Entity;
    ...
    {
        var entity = await GetByIdAsync(id, true, cancellationToken) ?? throw new ArgumentNullException();
